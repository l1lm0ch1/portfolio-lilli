...
const projectsData = {
    ...
    'cozy-place': {
        ...
        longDescription: {
            de: 'Cozy Place entstand im Rahmen des 3D-Kurses an der FH Hagenberg und diente als erster Einstieg in Autodesk Maya. Ich habe mich dafür entschieden, einen persönlichen Gamer-Raum zu gestalten, klein, aber voller Details, die mir wichtig sind. Der Raum beinhaltet Poster von Spielen, die mir besonders viel bedeuten, sowie eine Referenz zu meiner eigenen Nintendo Wii. Als persönliches Highlight habe ich außerdem ein Prop-Katana eingebaut. Das Projekt hat mir gezeigt, wie man mit 3D-Modelling persönliche Geschichten erzählen kann.',
    ...
    'blurred-thoughts': {
        ...
        longDescription: {
            de: 'Blurred Thoughts ist ein düsteres First-Person Escape Room Puzzle-Spiel, das beim Hagenberg Game Jam 2024 entstanden ist. Das Thema lautete "Blast from the Past". In nur zwei Tagen haben wir als fünfköpfiges Team dieses Spiel entwickelt, angetrieben von Energy Drinks, Kaffee, dem obligatorischen McDonald\'s-Break und sogar einer dreistündigen Rave-Party um Mitternacht. Nebenbei haben wir das Spiel direkt gespeedrunnt, leider ohne unsere Zeiten festzuhalten. Die Geschichte beginnt in einem alten Klassenzimmer: Der Protagonist erwacht ohne jede Erinnerung an seine Identität. VHS-Kassetten enthüllen nach und nach Fragmente seiner Vergangenheit. Im letzten Level kommt es zum Höhepunkt: Die letzte Kassette rät schlicht: "Take it off." Der Protagonist zieht das VR-Headset im Spiel aus und findet sich plötzlich in einer hellen, bunten Umgebung wieder. Die Auflösung: Der Hauptcharakter war Teil eines Therapieprogramms zur Behandlung von Gedächtnisverlust. Das Spiel endet im Büro eines Therapeuten, ein Symbol für Heilung und Selbstentdeckung. Für mich war Blurred Thoughts eine Lektion in kreativem Arbeiten unter extremem Zeitdruck. Wir haben Platz 4 von 15 Teams belegt.',
            en: 'Blurred Thoughts is a dark first-person escape room puzzle game created at the Hagenberg Game Jam 2024, under the theme "Blast from the Past." In just two days, our five-person team built this game, fueled by energy drinks, coffee, the mandatory McDonald\'s break, and even a three-hour rave party at midnight. We also started speedrunning it on the side, though sadly we never wrote down our times. The story begins in an old classroom, where the protagonist wakes up with no memory of who he is. VHS tapes slowly reveal fragments of his past. The climax arrives in the final level, when the last tape simply advises: "Take it off." The protagonist removes his VR headset in-game and suddenly finds himself in a bright, colorful environment. The reveal reframes everything: the protagonist was part of a specialized therapy program for memory recovery. The game ends in a therapist\'s office, symbolizing healing and self-discovery. Blurred Thoughts taught me a lot about rapid prototyping, narrative design, and how atmosphere can carry a game just as strongly as mechanics. We ranked 4th out of 15 teams.',
        },
        tags: ['Unity', 'Audio Design', 'Puzzle', 'C#', 'Music'],
        tech: ['Unity', 'C#', 'FMOD', 'Audio Programming'],
        images: [
    ...
    'archangel-vr': {
        ...
        links: {},
        description: {
            de: 'Ein narratives VR-Erlebnis im Weltkrieg mit Sci-Fi-Twist.',
            en: 'A narrative VR experience set in a World War with a sci-fi twist.',
        },
        longDescription: {
            de: 'Archangel versetzt dich in die Rolle eines Soldaten, der nach einem Fallschirmabsturz im Feindesgebiet aufwacht. Desorientiert und allein kämpfst du dich durch verrauchte Schützengräben, bis du einen verletzten jungen Soldaten findest, den du in Sicherheit bringen musst. Was wie eine einfache Rettungsmission beginnt, entwickelt sich zu etwas viel Dunklererem. Während du ein kaputtes Radio reparierst um Kontakt zu deiner Einheit aufzunehmen, stößt du auf Hinweise, die alles in Frage stellen. Am Ende wartet eine Wendung, die das gesamte Erlebnis neu rahmt. Archangel entstand als Semesterprojekt an der FH Hagenberg und war als Hauptentwicklerin mein bisher ambitioniertestes VR-Projekt.',
            en: 'Archangel puts you in the role of a soldier who wakes up after a parachute crash in enemy territory. Disoriented and alone, you fight your way through smoky trenches until you find a wounded young soldier you need to bring to safety. What begins as a simple rescue mission develops into something far darker. While repairing a broken radio to make contact with your unit, you stumble upon clues that call everything into question. At the end, a twist reframes the entire experience. Archangel was created as a semester project at the University of Applied Sciences Upper Austria and was my most ambitious VR project to date as the main developer.',
        },
